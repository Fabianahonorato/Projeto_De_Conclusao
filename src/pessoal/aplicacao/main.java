...
public class main {
	...
	private static void adicionarItem() {
	    ...
	    String dataPublicacao = scanner.nextLine(); service.adicionarItem(new Revista(titulo, autorArtista, 
	        			 categoria, numeroEdicao, dataPublicacao));
	        			                     break;
	    case 3:
	    ...
	    String genero = scanner.nextLine();service.adicionarItem(new AlbumMusica(titulo, autorArtista, 
	        			 categoria, numeroFaixas, genero));break;
	        			                 default:
